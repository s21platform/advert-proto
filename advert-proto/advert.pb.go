...
func (x *AdvertText) GetExpiredAt() *timestamp.Timestamp {
	if x != nil {
		return x.ExpiredAt
	}
	return nil
...
var file_advert_proto_rawDesc = string([]byte{
	...
	,
...
var file_advert_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
...
var file_advert_proto_depIdxs = []int32{
	5, // 0: AdvertText.expired_at:type_name -> google.protobuf.Timestamp
	1, // 1: GetAdvertsOut.adverts:type_name -> AdvertText
	3, // 2: CreateAdvertIn.user:type_name -> UserFilter
	5, // 3: CreateAdvertIn.expired_at:type_name -> google.protobuf.Timestamp
	0, // 4: AdvertService.GetAdverts:input_type -> AdvertEmpty
	4, // 5: AdvertService.CreateAdvert:input_type -> CreateAdvertIn
	2, // 6: AdvertService.GetAdverts:output_type -> GetAdvertsOut
	0, // 7: AdvertService.CreateAdvert:output_type -> AdvertEmpty
